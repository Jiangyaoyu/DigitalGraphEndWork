...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphicsViewRightTop = QtWidgets.QGraphicsView(self.centralwidget)
        self.graphicsViewRightTop.setGeometry(QtCore.QRect(780, 30, 421, 241))
        self.graphicsViewRightTop.setObjectName("graphicsViewRightTop")
        self.graphicsViewRightCenter = QtWidgets.QGraphicsView(self.centralwidget)
        self.graphicsViewRightCenter.setGeometry(QtCore.QRect(780, 550, 421, 241))
        self.graphicsViewRightCenter.setObjectName("graphicsViewRightCenter")
        self.graphicsView_3 = QtWidgets.QGraphicsView(self.centralwidget)
        self.graphicsView_3.setGeometry(QtCore.QRect(780, 290, 421, 241))
        ...
        self.menu.setGeometry(QtCore.QRect(540, 137, 119, 126))
        font = QtGui.QFont()
        ...
        self.menu_2.setGeometry(QtCore.QRect(359, 143, 114, 158))
        ...
        self.closeProcess.trigger(self.closeProcess.trigger())
        self.openProcess.trigger(self.openProcess.trigger())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.closeProcess.setText(_translate("MainWindow", "bi"))
        self.openProcess.setText(_translate("MainWindow", "kai"))
